...
import { productRequest, Category, CategoryDisplayNames, type ProductRequest, type ProductResponse } from "@/schema/product.schema";
...
export function ProductEdit({ open, onOpenChange, product, onProductUpdated }: ProductEditProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={handleClose}>
            <DialogContent className="sm:max-w-[500px]">
                <DialogHeader>
                    <DialogTitle className="text-primary">Chỉnh sửa sản phẩm</DialogTitle>
                </DialogHeader>
